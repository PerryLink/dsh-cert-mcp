...
- Node `^22.19.0 || >=24.0.0`।
- DSH `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0 || >=0.1.6-0 <0.2.0 || >=0.1.7-0 <0.2.0` (`engines.dsh` में घोषित, साथ में `dsh.manifestVersion: 1`)।
...
```sh
pnpm install
pnpm run typecheck                            # प्रकाशित रूलर: इंस्टॉल host सतह पर checkJs
pnpm run typecheck:checkout                   # चेकआउट रूलर: वही फ़ाइल-समुच्चय स्थानीय harness चेकआउट के बिल्ट टाइप पर
...
अब **दो** टाइप रूलर हैं, दोनों एक ही host लाइन पर। `typecheck` इस रेपो के अपने `node_modules` (पिन की गई devDependencies, यानी प्रकाशित `0.1.7-rc.1` लाइन) से `@deepseek-ai/*` resolve करता है और पैकेज कोई DSH peer घोषित नहीं करता, इसलिए यह प्रकाशित सतह नापता है। `typecheck:checkout` उसी फ़ाइल-समुच्चय को `tsconfig.checkout.json` के `paths` ब्लॉक से स्थानीय harness चेकआउट की बिल्ट टाइप सतहों पर कम्पाइल करता है (चेकआउट चार स्तर ऊपर है), इसलिए प्रकाशित पैकेज जिस टूटन को छिपा देते, वह भी यहाँ पकड़ी जाती है। `typecheck:ci` स्क्रिप्ट ऐतिहासिक no-op प्रतिलिपि है (उसका अतिरिक्त मात्र खाली `paths: {}` है) और पुराने संदर्भों के लिए रखी गई है, तीसरी टाइप सतह के रूप में नहीं। स्वतंत्र दूसरा साक्ष्य ऊपर दिया गया रनटाइम माउंट गेट है।

**लागू DSH संस्करण:** `dsh-v0.1.7-rc.1` (यह बिल्ड जिस होस्ट रिलीज़ को लक्षित करता है) पर सत्यापित; आवश्यक `>=0.1.7-alpha.1 <0.2.0`।
